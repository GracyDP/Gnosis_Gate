...
//                    System.out.println("[buildParsedColumns]"+c+" parso a: "+c.getLong(l));
                ...
                pColumns.add(pColumn);
                for (int l = 0; l < c.getLineCount(); ++l) {
//                    System.out.println("[buildParsedColumns]"+c+" parso a getDouble: "+c.getDouble(l));
                ...
                pColumns.add(pColumn);
                for (int l = 0; l < c.getLineCount(); ++l) {
//                    System.out.println("[buildParsedColumns]"+c+" parso a getString: "+c.getString(l));
                    pColumn.addLine(c.getString(l));
                }   
//            	System.out.println("providerS: "+providerS.entrySet());
            }
        }
    ...
    private int[][] buildIntInputOriginal(List<ParsedColumn<?>> pColumns) {
...
//                System.out.println("[buildIntInput] currIntInput["+col+"]["+row+"]: "+currIntInput[col][row]);
            }
        }
    ...
    private int[][] buildIntInput(List<ParsedColumn<?>> pColumns) {
        IndexProvider.sort(providerL); //long
        IndexProvider.sort(providerD); //double
    	System.out.println("providerL: "+providerL.entrySet());
    	System.out.println("providerD: "+providerD.entrySet());
